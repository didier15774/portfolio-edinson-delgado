/**
 * Genera portada WebP de AProbar desde la pieza promocional.
 * Fuente: assets/project-covers/aprobar-cover.jpg
 */
'use strict';
...
const SRC = path.join(__dirname, '..', 'assets', 'project-covers', 'aprobar-cover.jpg');
const OUT = path.join(__dirname, '..', 'public', 'images', 'projects', 'aprobar-cover.webp');
const RATIO = 16 / 9;
const MAX_W = 1600;
const MAX_H = 900;
...
(async () => {
  ...
  console.log(`✓ aprobar-cover.webp ${w}×${h} → ${out.width}×${out.height}`);
